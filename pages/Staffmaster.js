...
export default class Staffmaster extends Component{
						...
						<div className="card-body">
							<div className="form-group row">
								...
								<div className="col-sm-9">
									<input type="text" className="form-control form-control-sm" id="inputPassword3" placeholder="Name"/>
								</div>
							</div>
							<div className="form-group row">
								<label htmlFor="inputPassword3" className="col-sm-3 col-form-label">Address</label>
								<div className="col-sm-9">
									<input type="text" className="form-control form-control-sm" id="inputPassword3" placeholder="Address" />
								</div>
							</div>
							<div className="form-group row">
								<label htmlFor="inputPassword3" className="col-sm-3 col-form-label">Telp</label>
								<div className="col-sm-9">
									<input type="text" className="form-control form-control-sm" id="inputPassword3" placeholder="Telp" />
								</div>
							</div>
								<div className="form-group row">
